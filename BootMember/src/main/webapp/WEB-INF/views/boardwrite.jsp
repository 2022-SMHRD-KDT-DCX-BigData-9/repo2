	...
	<header>
		...
		<div class="nav-icon">
			<a href="#"></a> <i class='bx bx-search'></i> <a href="#"></a> <i
				class='bx bx-user'></i> <a href="login.jsp"></a> <i
				class='bx bx-cart'></i>
	...
	<form action="boardWrite" method="post" enctype="multipart/form-data">
		<div class="container">
			<table>
				...
				<tr>
					<td><input type="text" id="sample5_address" placeholder="주소" name="item_place">
				...
				<tr>
					...
					<td>
						<center><div id="map"
							style="width: 300px; height: 300px; margin-top: 10px; display: none"></div></center>
					</td>
